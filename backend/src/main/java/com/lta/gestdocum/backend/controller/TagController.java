...
@Tag(name = "Etiquetas", description = "Etiquetas documentales del tenant autenticado")
...
public class TagController {
    ...
    public ResponseEntity<Page<TagResponse>> find(
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('configuration:read')")
    @Operation(summary = "Consultar etiqueta")
